...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php wp_head(); ?> <!-- this allows you to use things like javascript -->

		
			<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/nivo-slider.css">
			<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/themes/light/light.css">
	...
	<body>
		<div id="wrapper">
			<header>
				<h1>
					<a href="<?php bloginfo('url'); ?>"> <!-- bloginfo function for url -->
						<?php bloginfo("name"); ?> <!--using bloginfo function to retrieve name of website-->
					</a>
				</h1> 
				<div class="clear"></div>
